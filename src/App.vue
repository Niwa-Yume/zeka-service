...
import logoV3 from '@/assets/logo-removebg-preview.png'
...
<template>
  <header class="header">
    <div class="container">
      <img class="logo" :src="logo" alt="ZEKA Services">
      <nav class="nav">
  ...
  <section id="hero" class="hero">
    <video
        class="hero-bg-video"
        src="@/assets/video/7578543-uhd_3840_2160_30fps.mp4"
        autoplay
        muted
        loop
        playsinline
  ...
  <section id="about" class="about">
    <div class="container">
      <h2 class="about-title">Notre ADN familial</h2>
      <p class="about-intro">
        Depuis 2010, <strong>ZEKA Services</strong> façonne vos espaces avec passion, savoir-faire et proximité.
      </p>

      <div class="about-grid">
        <div class="about-item">
          <i class="icon-mission"></i>
          <h3 class="about-subtitle">Notre mission</h3>
          <p class="about-text">
            Créer, innover et exécuter vos projets avec qualité et distinction.
          </p>
        </div>
        <div class="about-item">
          <i class="icon-history"></i>
          <h3 class="about-subtitle">Notre histoire</h3>
          <p class="about-text">
            Une entreprise familiale, une équipe dynamique et ouverte d’esprit à votre service.
          </p>
        </div>
        <div class="about-item">
          <i class="icon-vision"></i>
          <h3 class="about-subtitle">Notre vision</h3>
          <p class="about-text">
            Garantir un service optimal et une satisfaction client à 100 %.
          </p>
        </div>
        <div class="about-item">
    ...
    <div class="container">
      ...
      <div class="contact-grid">
        <div class="contact-details">
          ...
          <div class="info-item">
            <svg class="icon" aria-hidden="true" viewBox="0 0 24 24">
              <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21c1.2.48 2.5.73 3.85.73a1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.35.25 2.65.73 3.85a1 1 0 01-.21 1.11l-2.2 2.2z"/>
            </svg>
            <p>
...
.hero-logo {
  ...
  margin: 0 auto 1.5rem auto; /* espace sous le logo */
}
/* Who We Are */
.who-we-are {
  padding: 4rem 1rem;
